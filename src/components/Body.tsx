  ...
  return (
    <div className="w-full mx-auto my-10 flex flex-col items-center space-y-[64px]">
        ...
        <div className="w-full mx-auto">
            <div className="flex gap-[16px] max-w-[656px] text-white mx-auto">
                <div className="bg-[#262540] w-[526px] rounded-[12px] flex items-center py-[16px] px-[24px] mx-auto gap-[16px]">
        ...
        <div className="w-full mx-auto md:flex text-white gap-[32px]">
            <div className="w-full lg:w-[800px] space-y-[32px]">
                <div className="w-full bg-blue-500 rounded-[20px] flex items-center justify-between py-[80px] px-[24px]">
                ...
                <div className='w-full flex flex-col gap-[20px]'>
                    ...
                    <div className='w-full grid grid-cols-3 md:grid-cols-7 gap-[16px]'>
            ...
            <div className="w-full lg:w-[384px] bg-[#262540] rounded-[20px] flex flex-col p-[24px] gap-[16px]">
                <div className='w-full flex justify-between items-center'>
                    <h1 className='text-[20px] font-semibold'>Hourly forcast</h1>

                    <div className="bg-[#3C3B5E] rounded-[8px] flex items-center gap-[12px] px-[16px] py-[8px] sm:px-[16px] sm:py-[12px]">
